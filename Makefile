...
test.o: parser/test.cc parser/ul-driver.hh \
		parser/ul-parser.hh \
		parser/stack.hh \
		parser/location.hh \
		parser/position.hh \
		parser/dialogue.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o test.o parser/test.cc
...
lex.yy.o: parser/lex.yy.c parser/ul-driver.hh \
		parser/ul-parser.hh \
		parser/stack.hh \
		parser/location.hh \
		parser/position.hh \
		parser/dialogue.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o lex.yy.o parser/lex.yy.c
